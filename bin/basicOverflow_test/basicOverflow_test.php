// Dafny program basicOverflow_test.dfy compiled into C#
...
// Command Line Options: /home/montp3/Desktop/eth2.0-dafny/test/dafny/basicOverflow_test.dfy /verifyAllModules /compile:1 /spillTargetCode:1 /out:bin/basicOverflow_test /compileTarget:php
// basicOverflow_test.dfy

type uint64 = x: int
  | 0 <= x < 1152921504606846976

method overflow(c: uint64)
  decreases c
{
  if c > 0 {
    var d: uint64 := 1152921504606846976 - 2;
    var a: uint64 := d + 1;
  }
}
")]
...
namespace _module {
  ...
  public partial class __default {
    public static void overflow(BigInteger c)
    {
      if ((c).Sign == 1) {
        BigInteger _13_d;
        _13_d = (new BigInteger(1152921504606846976L)) - (new BigInteger(2));
        BigInteger _14_a;
        _14_a = (_13_d) + (BigInteger.One);
      }
    }
  }
